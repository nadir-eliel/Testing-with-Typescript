...
describe('ReservationsHandler test suite', () => {
    ...
    describe('GET requests', () => {
        ...
        it('should return all reservations for /all request', async () => {
            ...
            reservationsDataAccessMock.getAllReservations.
                mockResolvedValueOnce([someReservation]);
        ...
        it('should return reservation for existing id', async () => {
            ...
            reservationsDataAccessMock.getReservation
                .mockResolvedValueOnce(someReservation);
    ...
    describe('DELETE requests', () => {
        ...
        it('should delete reservation with provided id', async () => {
            ...
            expect(reservationsDataAccessMock.deleteReservation)
                .toHaveBeenCalledWith(someReservationId);
